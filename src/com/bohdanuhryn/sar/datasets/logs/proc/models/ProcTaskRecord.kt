package com.bohdanuhryn.sar.datasets.logs.proc.models
...
(2) comm %s thread name or process name (k.media.example)
(3) state %c One of the following characters, indicating process state. Common values ​​are as follows: (S in this example)
R Running
S Sleeping in an interruptible wait
D Waiting in uninterruptible disk sleep
Z Zombie
(4) ppid %d The PID of the parent of this process. 1758
...
(18) priority %ld priority, the value is between 0 (high)-39 (low), in this example it is 20
(19) nice %ld The nice value (see setpriority(2)), a value in the range 19 (low priority) to -20 (high priority). 0
(20) num_threads %ld The number of threads, in this case 21
(21) itrealvalue %ld hard coded as 0.
(22) starttime %llu The time the process started after system boot. 8405754
...
(39) On which CPU core was processor %d last executed (since Linux 2.2.8) CPU number last executed on. 3
...
data class ProcTaskRecord(
    ...
    val state: String,
    val minorFaults: String,
    val minorFaultsChildren: String,
    val majorFaults: String,
    val majorFaultsChildren: String,
    val userTime: String,
    val systemTime: String,
    val userTimeChildren: String,
    val systemTimeChildren: String,
    val threadsNum: String,
    val startTime: String,
    val virtualMemorySize: String,
    val rss: String,
    val rssLim: String
) : LogRecord, CsvRow {
